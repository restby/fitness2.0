...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/tabs/init-tabs":11,"./modules/video-player":13,"./utils/ios-vh-fix":15,"./vendor/init-swiper":16}],2:[function(require,module,exports){
"use strict";
...
var play = function play() {
  if (document.querySelector('[data-id="video"]')) {
    ...
    var videoBtnPlay = document.querySelector('.video__btn');
...
exports.initTrainersSlider = exports.initReviewsSlider = void 0;
var trainersSwiper = document.querySelector('.trainers__slider');
var commentsSwiper = document.querySelector('.reviews__slider');
